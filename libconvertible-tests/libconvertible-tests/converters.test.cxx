...
SCENARIO("convertible: Converters")
{
  ...
  GIVEN("explicit_cast")
  {
    TEST_CASE_TEMPLATE_INVOKE(
      ...
      std::tuple<converter::explicit_cast<int, converter::identity>, int&, int&>);
    TEST_CASE_TEMPLATE_INVOKE(
      invocable_with_types,
      std::tuple<converter::explicit_cast<int, converter::identity>, int&&, int&&>);
    TEST_CASE_TEMPLATE_INVOKE(invocable_with_types,
                              std::tuple<converter::explicit_cast<std::string, converter::identity>,
    ...
    TEST_CASE_TEMPLATE_INVOKE(
      invocable_with_types,
      std::tuple<converter::explicit_cast<std::string, int_string_converter>, int&, std::string>);
    TEST_CASE_TEMPLATE_INVOKE(
      invocable_with_types, std::tuple<converter::explicit_cast<std::string, int_string_converter>,
                                       int const&, std::string>);
    TEST_CASE_TEMPLATE_INVOKE(
      invocable_with_types,
      std::tuple<converter::explicit_cast<int, int_string_converter>, std::string&, int>);
    TEST_CASE_TEMPLATE_INVOKE(
      invocable_with_types,
      std::tuple<converter::explicit_cast<proxy<std::string>, int_string_converter>, int&,
                 std::string>);
    TEST_CASE_TEMPLATE_INVOKE(
      invocable_with_types,
      std::tuple<converter::explicit_cast<proxy<std::string const>, int_string_converter>,
                 int const&, std::string>);
  }
}
